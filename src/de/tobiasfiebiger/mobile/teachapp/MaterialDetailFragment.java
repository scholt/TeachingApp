 ...
 * either contained in a {@link MaterialListActivity} in two-pane mode (on
 * tablets) or a {@link MaterialDetailActivity} on handsets.
 */
public class MaterialDetailFragment extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
	...
	if (mItem != null) {
	  ((TextView) rootView.findViewById(R.id.material_detail)).setText(mItem.content);
	}
