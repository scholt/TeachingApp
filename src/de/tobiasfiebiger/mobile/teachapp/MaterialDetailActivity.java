 ...
 * presented side-by-side with a list of items in a {@link MaterialListActivity}
 * .
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing more than
 * a {@link MaterialDetailFragment}.
 */
public class MaterialDetailActivity extends FragmentActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
	...
	if (savedInstanceState == null) {
	  ...
	  arguments.putString(MaterialDetailFragment.ARG_ITEM_ID, getIntent().getStringExtra(MaterialDetailFragment.ARG_ITEM_ID));
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
	...
	case android.R.id.home:
	  ...
	  //
	  NavUtils.navigateUpTo(this, new Intent(this, MaterialListActivity.class));
	  return true;
	}
